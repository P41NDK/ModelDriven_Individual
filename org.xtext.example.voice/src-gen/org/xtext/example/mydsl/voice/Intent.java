...
public interface Intent extends Agent
{
   ...
   * @see #setZuper(Intent)
   * @see org.xtext.example.mydsl.voice.VoicePackage#getIntent_Zuper()
   * @model
   * @generated
   */
  Intent getZuper();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.voice.Intent#getZuper <em>Zuper</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
