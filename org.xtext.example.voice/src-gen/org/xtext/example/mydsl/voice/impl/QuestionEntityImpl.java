 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.voice.impl.QuestionEntityImpl#getWithEntity <em>With Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuestionEntityImpl extends MinimalEObjectImpl.Container implements QuestionEntity
{
  ...
  {
    return VoicePackage.Literals.QUESTION_ENTITY;
  }
  ...
  public NotificationChain basicSetWithEntity(Reference newWithEntity, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VoicePackage.QUESTION_ENTITY__WITH_ENTITY, oldWithEntity, newWithEntity);
  ...
  public void setWithEntity(Reference newWithEntity)
  {
    if (newWithEntity != withEntity)
    {
      ...
      if (withEntity != null)
        msgs = ((InternalEObject)withEntity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VoicePackage.QUESTION_ENTITY__WITH_ENTITY, null, msgs);
      if (newWithEntity != null)
        msgs = ((InternalEObject)newWithEntity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VoicePackage.QUESTION_ENTITY__WITH_ENTITY, null, msgs);
      msgs = basicSetWithEntity(newWithEntity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, VoicePackage.QUESTION_ENTITY__WITH_ENTITY, newWithEntity, newWithEntity));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case VoicePackage.QUESTION_ENTITY__WITH_ENTITY:
